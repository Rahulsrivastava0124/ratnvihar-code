            ...
            <div className={`desktop_menu menubar ${scroll >= 0 ? "fixed-top" : ""}`} >
                            ...
                            <ul>
                                <li>
                                    ...
                                    <div className='c-content'>
                                        <Link to="/products?recent_view=1"><span>Recently <br /> Viewed</span></Link>
                                    </div>
                                ...
                                <li>
                                    ...
                                    <div className='c-icon' onClick={onWishList}>
                                        <BiHeart />
                                        <span className='c-price' onClick={onWishList}>{wishList?.total}</span>
                                    </div>
                ...
                <div className='menu-wrapper'>
                    <Navbar bg="light" expand="lg">
                        <Container fluid className='position-relative justify-content-center'>
                                            ...
                                            <div key={index}>
                                                ...
                                                >
                                                    {val.subCategories.map((sub, index) => (<div key={index}>
                                                        <NavDropdown.Item href={`/products?category=${val.slug}&subcategory=${sub.slug}`}>{sub.name}</NavDropdown.Item></div>))}
                                                </NavDropdown>
                                            </div>
                                        ))
                                    }
                                                    ...
                                                    <div className='mobile-menu-inner-wrapper'>
                                                        ...
                                                        <ul>
                                                            ...
                                                            }
                                                            {
                                                                !auth.isLoggedIn ?
                                                                    <li>
                                                                        <Button variant="primary" onClick={handleSingup}>Signup</Button>
                                                                    </li>
                                                                    : null
                                                            }
                                                        </ul>
                                    ...
                                    <Offcanvas.Body>
                                        <Nav className="justify-content-end flex-grow-1">
                                            ...
                                            <li className='b_mobile_icon'>
                                                ...
                                                <div className='c-content'>
                                                    <a href='/products?recent_view=1'><span>Recently  Viewed</span></a>
                                                </div>
