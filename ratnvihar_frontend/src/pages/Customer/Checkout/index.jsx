                  ...
                  {this.state.isLoggedIn ? (
                    <>
                      {addressList.map((item, key) => (
                        <div className="single-address my-2 border rounded p-2" key={key}>
                        ...
                        <Row>
                          <Col xs={12} md={12}>
                            ...
                            <div className="form-inner-control mb-2 mt-2">
                              <InputGroup
                                className={
                                  addressFormErrors.name ? " error_input" : ""
                                }
                              >
                                <InputGroup.Text id="basic-addon1">
                                  <AiOutlineUser />
                                ...
                                >
                                  <Form.Control
                                    ...
                                    className={
                                      addressFormErrors.name ? "is-invalid" : ""
                                    }
                                  />
                                </FloatingLabel>
                              </InputGroup>
                        ...
                        <Row>
                          ...
                          <Col xs={12} md={6}>
                            <div className="form-inner-control mb-2">
                              <InputGroup
                                className={
                                  addressFormErrors.city ? " error_input" : ""
                                }
                              >
                                <InputGroup.Text id="basic-addon1">
                                  <AiOutlineMail />
                                ...
                                >
                                  <Form.Control
                                    ...
                                    className={
                                      addressFormErrors.city ? "is-invalid" : ""
                                    }
                                  />
                                </FloatingLabel>
                              </InputGroup>
                            ...
                            <div>
                              ...
                              {item.cart_material.map((val, key) => (
                                <h5 key={key}>
                                  {val.material}:{" "}
                                  {val.quantity > 0
                                    ? val.quantity + " " + val.material + ", "
                                    : ""}{" "}
                                  {val.purity_name}, {val.weight}{" "}
                                  {val.unit_name}
                                </h5>
                              ))}
                      ...
                      {this.isSalesExecutive ? (
                        <span className="place-order gap-2 mb-2">
                          <Row>
                            ...
                            <Col
                              xs={12}
                              md={this.state.payment_mode == "cheque" ? 6 : 12}
                            >
