...
import { isSalesExecutive, isRetailer, isEmpty, isCustomer, isObject, displayAmount, priceFormat, toBase64 } from "helpers/helper";
...
import { AddressFetch, AddressListRaw, getCountries, getStates, getDistricts } from "actions/Customer/address.actions";
...
class CheckoutPage extends React.Component {
    ...
    componentDidUpdate(prevProps) {
        ...
        if (prevProps.retailerList !== this.props.retailerList && this.props.retailerList.length && this.props.query.get('new_created') == 1) {
    ...
    handlePlaceOrder = async () => {
        ...
        let data = {
            ...
            total_amount: this.state.discount_amount ? priceFormat(this.state.total_payable - this.state.discount_amount) : this.state.total_payable,
            ...
            image_file: this.state.image_file ? await toBase64(this.state.image_file) : ''
        }
    ...
    render() {
        const { newAddress, addressForm, addressFormErrors, addressList, countryList, stateList, districtList, loginError, formValaues, formErrors } = this.state;
                        ...
                        <Row>
                            <Col xs={12} md={7} className="order">
                                <div className='checkout-single-wrapper bg-white border-right'>
                                        ...
                                        <div className='header'>
...

                                            {
                                                !this.state.isLoggedIn ?
                                                    <>
                                                        <h5>Your Details <span>Required to Save Cart and Send Order Updates</span></h5>
                                                        <div className='login-address-details'>
                                                            ...
                                                            <Form onSubmit={this.onLoginSubmit}>
                                                                <Row>
                                                                    <Col xs={12} md={6}>
                                                                        <InputGroup className={"mb-3" + (formErrors.mobile ? ' error_input' : '')}>
                                                                            <InputGroup.Text id="basic-addon1"><BsPhone /></InputGroup.Text>
                                                                            <FloatingLabel
                                                                                label="Mobile #"
                                                                                className=""
                                                                            >
                                                                                <Form.Control type="text" placeholder="Enter mobile number" name='mobile' onChange={(e) => this.handleLoginFormChange(e)} value={formValaues.mobile} disabled={this.state.login_step != 0 ? true : false} />
                                                                            </FloatingLabel>
                                                                        </InputGroup>
                                                                    </Col>
                                                                    {
                                                                        this.state.login_step == 2 ?
                                                                            <Col xs={12} md={6}>
                                                                                <InputGroup className={"mb-3" + (formErrors.email ? ' error_input' : '')}>
                                                                                    ...
                                                                                    <FloatingLabel
                                                                                        ...
                                                                                        className=""
                                                                                    >
                                                                                        <Form.Control type="text" placeholder="Email" name="email" onChange={(e) => this.handleLoginFormChange(e)} value={formValaues.email} />
                                                                                    </FloatingLabel>
                                                                                </InputGroup>
                                                                            </Col>
                                                                            : null
                                                                    }
                                                                    {
                                                                        this.state.login_step == 2 ?
                                                                            <Col xs={12} md={6}>
                                                                                <InputGroup className={"mb-3" + (formErrors.name ? ' error_input' : '')}>
                                                                                    ...
                                                                                    <FloatingLabel
                                                                                        ...
                                                                                        className=""
                                                                                    >
                                                                                        <Form.Control type="text" placeholder="Name" name="name" onChange={(e) => this.handleLoginFormChange(e)} value={formValaues.name} />
                                                                                    </FloatingLabel>
                                                                                </InputGroup>
                                                                            </Col>
                                                                            : null
                                                                    }
                                                                    {
                                                                        this.state.login_step != 0 ?
                                                                            <Col xs={12} md={6}>
                                                                                <InputGroup className={"mb-3" + (formErrors.password ? ' error_input' : '')}>
                                                                                    ...
                                                                                    <FloatingLabel
                                                                                        ...
                                                                                        className=""
                                                                                    >
                                                                                        <Form.Control type="password" placeholder="Password" name="password" onChange={(e) => this.handleLoginFormChange(e)} value={formValaues.password} />
                                                                                    </FloatingLabel>
                                                                                </InputGroup>
                                                                            </Col>
                                                                            : null
                                                                    ...
                                                                    <Col xs={12}>
                                                                        {
                                                                            this.state.login_step != 0 ?
                                                                                <Button variant="primary" className='add_submit' type="button" onClick={this.handleLoginReset}>
                                                                                    RESET
                                                                                </Button>
                                                                                : null
                                                                        }
                                                                        &nbsp;
                                                                        <Button variant="primary" className='add_submit' type="submit">
                                                                            CONTINUE
                                                                        </Button>
                                                                    </Col>
...

                                        {
                                            this.isRetailer && this.state.isLoggedIn ?
                                                <div style={{ flexGrow: 1 }}>
                                                    <Form.Group>
                                                        <Form.Label className='se_heading'>Sales Executive</Form.Label>
                                                        <Form.Select onChange={(e) => this.retailerChange(e.target.value)} value={this.state.user_id}>
                                                            <option value=""></option>
                                                            {
                                                                this.state.salesExecutiveList.map((item, index) => (
                                                ...
                                                <div style={{ flexGrow: 1 }}>
                                                    <Form.Group>
                                                        <Form.Label className='retailer_heading'>
                                                            Retailer
                                                            <span className='add_new_rtlr' onClick={this.addNewRetailer}>Add New</span>
                                                        </Form.Label>
                                                        <Select
                                                            ...
                                                            <div className='single-address-header'>
                                                                <div className='address-radio'>
                                                                    <Form.Check
                                                                        ...
                                                                        checked={this.state.address_id == item.id ? true : false}
                                                                    />
                                                                    <span>{item.name}</span>
                                    ...
                                    {newAddress &&
                                        <Form onSubmit={this.onAddressSubmit} className="login-address-details">
                                            <Form.Group>
                                                <Row>
                                                    <Col xs={12} md={12}>
                                                        {/* <Form.Label>Name : </Form.Label> */}
                                                        <div className='form-inner-control mb-2 mt-2'>
                                                            <InputGroup className={addressFormErrors.name ? ' error_input' : ''}>
                                                                <InputGroup.Text id="basic-addon1"><AiOutlineUser /></InputGroup.Text>
                                                                <FloatingLabel
                                                                    controlId="floatingInput"
                                    ...
                                    />*/}
                                                ...
                                                <Row>
                                                    <Col xs={12} md={6}>
                                                        <div className='form-inner-control mb-2'>
                                                            <InputGroup className={addressFormErrors.contact ? ' error_input' : ''}>
                                                                <InputGroup.Text id="basic-addon1"><BsPhone /></InputGroup.Text>
                                                                <FloatingLabel
                                                                    controlId="floatingInput"
                                                                    label="Phone Number"
                                                    ...
                                                    <Col xs={12} md={6}>
                                                        ...
                                                        <div className='form-inner-control mb-2'>
                                                            <InputGroup className={addressFormErrors.zipcode ? ' error_input' : ''}>
                                                        ...
                                                        <div className='form-inner-control mb-2'>
                                                            ...
                                                            >
                                                                <Form.Select
                                                                    ...
                                                                    onChange={(e) => this.handleAddressChange(e)}
                                                                    className={addressFormErrors.country_id ? 'is-invalid error_input' : ''}
                                                                >
                                                        ...
                                                        <div className='form-inner-control mb-2'>
                                                            ...
                                                            >
                                                                <Form.Select
                                                                    ...
                                                                    onChange={(e) => this.handleAddressChange(e)}
                                                                    className={addressFormErrors.state_id ? 'is-invalid error_input' : ''}
                                                                >
                                            ...
                                            <Form.Group className="">
                                                <Row>
                                                        ...
                                                        <div className='form-inner-control mb-2'>
                                                            ...
                                                            >
                                                                <Form.Select
                                                                    ...
                                                                    onChange={(e) => this.handleAddressChange(e)}
                                                                    className={addressFormErrors.district_id ? 'is-invalid error_input' : ''}
                                                                >
                                                    ...
                                                    <Col xs={12} md={6}>
                                                        <div className='form-inner-control mb-2'>
                                                            <InputGroup className={addressFormErrors.city ? ' error_input' : ''}>
                                                                <InputGroup.Text id="basic-addon1"><AiOutlineMail /></InputGroup.Text>
                                                                <FloatingLabel
                                                                    controlId="floatingInput"
                                                                    label="Town/ City"
                                                ...
                                                <div className='form-inner-control mb-2'>
                                                    ...
                                                    >
                                                        <Form.Select name='type' value={addressForm.type}
                                                            onChange={(e) => this.handleAddressChange(e)}
                                                            className={addressFormErrors.type ? 'is-invalid error_input' : ''}
                                                        >
                            ...
                            <Col xs={12} md={5} className="">
                                <div className='checkout-single-wrapper padding-left'>
                                    <div className='checkout-summary-area'>
                                        ...
                                        <div style={{ display: 'block', height: '1px', width: '100%', background: '#cdcdcd', margin: '5px 0  ' }}></div>
                                                            ...
                                                            <div className='checkout_price_header justify-content-between d-flex'>
                                                                ...
                                                                <div className='checkout-price'>
                                                                    <h4>
                                                                        {
                                                                            item.have_offer ?
                                                                                <span className="strikethrough">{item.total_price_without_dis_display}</span> :
                                                                                null
                                                                        }
                                        ...
                                        <div style={{ display: 'block', height: '1px', width: '100%', background: '#cdcdcd', margin: '5px 0  ' }}></div>
                                        <div className="checkout-total d-flex justify-content-between mb-2 align-items-center"><span><h6>Total Amount </h6> </span><span tyle="color: black;"><h6> {this.state.original_price} </h6></span></div>
                                        <div style={{ display: 'block', height: '1px', width: '100%', background: '#cdcdcd', margin: '5px 0  ' }}></div>
                                        <div className="checkout-total d-flex justify-content-between mb-2 align-items-center"><span><h6>Discount </h6> </span><span tyle="color: black;"><h6> {this.state.total_discount} </h6></span></div>
                                        <div style={{ display: 'block', height: '1px', width: '100%', background: '#cdcdcd', margin: '5px 0  ' }}></div>
                                        {
                                            !isEmpty(this.state.promocode) ?
                                                <>
                                                    <div className="checkout-total d-flex justify-content-between mb-2 align-items-center"><span><h6>Voucher code ( {this.state.promocode} ) </h6> </span><span tyle="color: black;"><h6> {this.state.promocode_discount_display} </h6></span></div>
                                                    <div style={{ display: 'block', height: '1px', width: '100%', background: '#cdcdcd', margin: '5px 0  ' }}></div>
                                                </>
                                                : null
                                        }
                                            ...
                                            this.isSalesExecutive ?
                                                <div className='checkout-total d-flex justify-content-between mb-2 align-items-center'>
                                                    ...
                                                    <span className='total-price' style={{ color: "black" }}>
                                                        <InputGroup>
                                                            <Form.Control name='discount_amount' value={this.state.discount_amount} onChange={this.handleCashDiscount} />
                                                        </InputGroup>
                                                    </span>
                                                </div>
                                                : null
                                        ...
                                        <div className='checkout-total d-flex justify-content-between mb-2 align-items-center'>
                                            ...
                                            <span className='total-price' style={{ color: "black" }}> {this.state.discount_amount ? displayAmount(this.state.total_payable - this.state.discount_amount) : this.state.total_payable_display} </span>
                                            {/* </span> */}
                                        </div>
                                        ...
                                        <span >  Online Payment  </span> 
                                            ...
                                            <span className='place-order gap-2 mb-2'>
                                                <Row>
                                                                ...
                                                                <Col xs={12} md={6}>
                                                                    <InputGroup>
                                                                        <FloatingLabel
                                                                            ...
                                                                            className=""
                                                                        >
                                                                            <Form.Control name='paid_amount' value={this.state.paid_amount}
                                                                ...
                                                                <Col xs={12} md={6}>
                                                                    <InputGroup>
                                                                        <FloatingLabel
                                                                            ...
                                                                            label="Payment Mode"
                                                                            className={"mb-3" + (this.state.payment_mode_err ? ' error_input' : '')}
                                                                        >
                                                                            <Form.Select
                                                                        ...
                                                                        <Col xs={12} md={6}>
                                                                            <InputGroup>
                                                                                <FloatingLabel
                                                                                    ...
                                                                                    className=""
                                                                                >
                                                                                    <Form.Control name='cheque_no' value={this.state.cheque_no}
                                                    ...
                                                    <Col xs={12} md={this.state.payment_mode == 'cheque' ? 6 : 12}>
                                                        <Form.Group controlId="formFile">
                                                            <Form.Control type="file" onChange={this.handleImage} accept="image/*" />
                                                        </Form.Group>
                                                    </Col>
                                                    <Col xs={12} md={12}>
                                                        <Form.Group className='mb-3 mt-3'>
                                                            <Form.Control as="textarea" rows={3} placeholder='Write notes...' value={this.state.notes} onChange={(e) => this.setState({ notes: e.target.value })} />
                                                        </Form.Group>
                                                    </Col>
                                                </Row>
                                            </span>
...
const mapDispatchToProps = dispatch => ({
    dispatch,
    actions: bindActionCreators({ checkoutList, CartList, OrderCreate, AddressCreate, retailerList, salesExecutiveList, login, signup }, dispatch)
});
