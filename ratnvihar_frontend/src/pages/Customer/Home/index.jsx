    ...
    return (
      <>
        ...
        {featured_products.length ? (
          <section className="feature-product bg-light">
            <Container>
              ...
              <Col xs={6} md={4}>
                <div className="promise-box">
                  ...
                  <div className="promise-overlay-content">
                    ...
                    <p>
                      The value of a precious stone or diamond is determined by
                      its gemological makeup, natural rarity and cut quality.
                      Diamonds and gems that look similar can vary greatly in
                      value. Experts need high equipment to detect synthetics,
                      remedies. A certificate clearly discloses the details of
                      any item, providing confidence to both the buyer and the
                      seller.
                    </p>
                    <p>
                      Gemstones should be exchanged only if there is a
                      certificate certifying the same. We provide reports from
                      the few trusted labs.
                    </p>
                    ...
                    <ul>
                      ...
                      <li>
                        IIGL Institute of International Gemological Laboratory
                      </li>
              ...
              <Col xs={6} md={4}>
                <div className="promise-box">
                  ...
                  <div className="promise-overlay-content">
                    ...
                    <div className="overlay-underline"></div>
                    <p>
                      हमारा 7 दिन की वापसी निति के तहत,आप को वस्तु पसंद नहीं आने
                      पर ,उचित कारण के साथ,आप उसे लौटा सकते हैं। जिसका 100% धन
                      राशि आपके बैंक खता में 7 दिन के भीतर जमा कर दिया जाता हैं
                      अगर कारण निराधार होने पर Making एवं संबधीत शुल्क लिया
                      जायेगा। सभी प्रकार के धन वापसी आपके बैंक खाते में
                      Trancefar के माध्यम से आपको संसाधित की जाएगी,अथवा, प्राप्त
                      किया गया स्रोत द्वारा जमा कीया जाएगा ,अतिआवश्यक होने पर
                      नगदी देने का प्रावधान भी हैं। वापस करने के सम्बन्ध में
                      वापसी के लिए निवेदन करने के बाद Labaratory Report के साथ
                      अपने गहनों का मूल पैकिंग सामग्री तैयार रखें पहचानपात्र के
                      साथ गए हुए रत्नविहार के कर्मचारी द्वारा दिया हुआ प्रूफ
                      पैकेट में अपने गहने कर्मचारी को दिखाकर सुरक्षित, इसे सील
                      कर दें। एक बार पैकेट सील करने के बाद, पैकेट को तब तक नहीं
                      खोला जा सकता जब तक कि उसे नष्ट न कर दिया जाए। पुस्टि होने
                      और पावती लेने के बाद ही वापसी हेतु वस्तु प्रदान करें हमें
                      वस्तु प्राप्त होने के उपरांत गुणवत्ता जांच के बाद 2 कार्य
                      दिवसों भीतर आपकी धन वापसी कर दीया जाता हैं यह सर्ते केवल
                      रत्न विहार द्वारा INVOICE बिल पर ही लागु हैं मान्य होगा।
                    </p>
                  </div>
                </div>
              </Col>
              ...
              <Col xs={6} md={4}>
                <div className="promise-box">
                  ...
                  <div className="promise-overlay-content">
                    ...
                    <div className="overlay-underline"></div>
                    <p>
                      We ship for free on all items. 100% safe which is our
                      responsibility to reach you safely from now on 100% Free
                      Delivery
                    </p>
                  </div>
                </div>
              ...
              <Col xs={6} md={4}>
                <div className="promise-box">
                  ...
                  <div className="promise-overlay-content">
                    ...
                    <div className="overlay-underline"></div>
                    <p>
                      We feel immense pleasure in providing the goods to our
                      customers at reasonable prices due to our bulk buying and
                      low margins and removal of middlemen.
                    </p>
                  </div>
                </div>
              </Col>
            ...
            <Row>
              <Col xs={12}>
                <div
                  ...
                  onClick={() => this.handlePromise("gemsjewellry1")}
                >
              ...
              <Col xs={12}>
                <div
                  ...
                  onClick={() => this.handlePromise("gemsjewellry2")}
                >
                  <div className="promise-mob-content">
                    <img src={refund} alt="" />
                    <h4 className="">
              ...
              <Col xs={12}>
                <div
                  ...
                  onClick={() => this.handlePromise("gemsjewellry3")}
                >
                  <div className="promise-mob-content">
                    <img src={exchange} alt="" />
              ...
              <Col xs={12}>
                <div
                  ...
                  onClick={() => this.handlePromise("gemsjewellry4")}
                >
                  <div className="promise-mob-content">
                    <img src={shipping} alt="" />
                    <h4 className="">
              ...
              <Col xs={12}>
                <div
                  ...
                  onClick={() => this.handlePromise("gemsjewellry5")}
                >
                  <div className="promise-mob-content">
                    <img src={jewelleryHome} alt="" />
                    <h4 className="">
            ...
            <Row>
              <Col xs={6} md={4}>
                <div className="browse-ring-header">
                  <h3 style={{ color: "#001e38" }}>Browse all Rings</h3>
                  <p>
          ...
          <section className="socialmedia-wrapper">
            <Container>
              <ul id="counter">
                ...
                <li className="rounded">
                  <span className="count percent">
                    <CountUp end={counts.retailers} suffix="+" duration={5} />
                  </span>
                  <div className="counter_header">
                    <h1>Retailers</h1>
                  </div>
