...
class Signup extends React.Component {
    ...
    onSubmit = (event) => {
       ...
       fetch("http://localhost:8089/signup/customer").then((data)=>data.json()).then((data)=>{
        console.log(data);
       })
                        ...
                        <Col xs={12} md={5}>
                            <div className='login-form-wrapper'>
                                ...
                                <form onSubmit={this.onSubmit} >
                                    <Form.Group className="mb-3 mt-3" controlId="formEmailAddress">
                                    ...
                                    <div className='signup-policy-wrapper'>
                                        <Form.Group className="mt-2 d-flex" controlId="formBasicCheckbox">
                                            <Form.Check type="checkbox" label="" />
                                            <span>I accept Ratn Vihar <a href='/terms-condition' target="_blank">  Terms of Service </a> and <a href='/privacy-policy' target="_blank"> Privacy Policy</a></span>
                                        </Form.Group>
                                    </div>
                                    <div className='login-button mb-3 mt-3'>
                                        <Button variant="primary" type="submit">SIGNUP</Button>
                                    </div>
                                    <p className='login-text mt-2 mb-2'>Already Have an Account? <a href="/login">Login</a></p>
                                    <hr />
                                ...
                                <div className='login-footer-button'>
                                    <Button variant="primary" className='email-btn' href="">SIGNUP WITH GOOGLE</Button>
                                    <Button variant="primary" className='fb-btn' href=""><FaFacebookF /> &nbsp; SIGNUP WITH FACEBOOK</Button>
                                </div>
                            </div>
                        </Col>
                    </Row>
