...
import { WishListData, WishListAdd, WishListRemove, WishListByNow } from 'actions/Customer/wishlist.actions';
                                ...
                                load ?
                                    ...
                                    <div className='ratn-wishlist'>
                                        {wishListItem.length > 0 ?
                                            wishListItem && wishListItem.map((val, index) => (
                                                <div className='cart-inner-wrapper' key={index}>
                                                    <div className='heading'>
                                                        ...
                                                        <div className='cart-icons'>
                                                            <h4 onClick={() => onRemove(val.id, index)}> <MdClose /> </h4>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div className='cart-image-content'>
                                                                ...
                                                                <div>
                                                                    ...
                                                                    </div>
                                                                    {
                                                                        val.making_charge_dis_percent > 0 ?
                                                                            <p className='making-charge'>({val.making_charge_dis_percent}% MAKING CHARGE OFF)</p>
                                                                            : null
                                                                    }
                                                                </div>
                                                            ...
                                                            <p className='p-variant'>Metal: <span>
                                                                ...
                                                                <div className='wishlist-buttons'>
                                                                    <Button variant="default" onClick={() => { navigate(`/products/${val.product_slug}`) }}>Open Product</Button>
                                                                    <Button variant="primary" onClick={() => onByNow(val.id)}>Buy Now</Button>
                                                                </div>
                                                            </div>
                            ...
                            wishListItem.map((val, index) => (
                                <Col xs={12} md={9} key={index}>
                                    <div className='cart-inner-wrapper'>
                                        ...
                                        <div className='cart-icons'>
                                            <Button variant="primary" onClick={() => onRemove(val.id, index)}>Remove</Button>
                                            <Button variant="primary" onClick={() => { navigate(`/products/${val.product_slug}`) }}>Open</Button>
                                            <Button variant="primary" onClick={() => onByNow(val.id)}>Buy Now</Button>
                                        </div>
                                    </div>
...
const mapDispatchToProps = dispatch => ({
    actions: bindActionCreators({ CartList, WishListAdd, WishListData }, dispatch)
});
