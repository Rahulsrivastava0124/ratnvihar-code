                            ...
                            <>
                                {this.state.items.length > 0 ?
                                    this.state.items.map((item, index) => (
                                        <div key={index}>
                                            <div className='my-order-wrapper mb-2'>
                                                <div className='order-id mb-2'>
                                                    <div className='id-no'>
                                                        <h2 className='mb-0'><span>{item.order_no}</span></h2>
                                                        {/*<h3>Gold Plated Ring + 1 Item</h3>*/}
                                                    </div>
                                                    <div className='total'>
                                                        <h5><span> {item.customer_name} </span></h5>
                                                    </div>
                                                    <div className='total'>
                                                        <h5><span> {item.total_amount} </span></h5>
                                                    </div>
                                                    <div className='tracker'>
                                                        <div className='order-status'>
                                                            <h4>Status: <span> {item.status_display}</span></h4>
                                                        </div>
                                                    </div>
                                                ...
                                                <div className='my-order-footer'>
                                                    ...
                                                    <div className='order-address'>
                                                        <div className='order-content'>
                                                            <h6>Expected Delivery Date :<span>{item.expected_delivery_date}</span></h6>
                                                        ...
                                                        <div className='tracker'>
                                                            ...
                                                            <Button variant="primary" className='mb-0' onClick={() => this.viewOrder(item.id)}>VIEW ORDER</Button>
                                                            {
                                                                ...
                                                                <Button variant="primary" className='mb-0'> <Link to={'/track-order/' + item.id}>TRACK ORDER </Link></Button>
                                                                : null
                                                            }
                                                        </div>
                                                    </div>
