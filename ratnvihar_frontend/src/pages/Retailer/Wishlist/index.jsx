                                                ...
                                                <div className='cart-inner-wrapper' key={index}>
                                                    <div className='heading'>
                                                        ...
                                                        <div className='cart-icons'>
                                                            <h4 onClick={() => onRemove(val.product_id)}> <MdClose /> </h4>
                                                        </div>
                                                    </div>
                                                    <div className='cart-inner'>
                                                        ...
                                                        <div className='cart-image-content'>
                                                            <div>
                                                                <div className='cart-image-title'>
                                                                    <p>Product Code : <span>{val.product_code || 289828490189210}</span></p>
                                                                </div>
                                                                <div>
                                                                <div className='price-wrapper'>
                                                                    <div className='cart-original-price'>
                                                                        <span className='strikethrough'>{val.display_discount || '₹8999'}</span>
                                                                    </div>
                                                                    <div className='cart-discount-price'>
                                                                        <span className='price'>{val.display_price || '₹6999'}</span>
                                                                    </div>
                                                                </div>
                                                                <p className='making-charge'>(0% MAKING CHARGE)</p>
                                                            </div>
                                                            <div className='p_description'>
                                                            <h4>Diamond PreSet Solitaire Ring In 18Kt Yellow Gold (3.77 gram) with 0.129 carats</h4>
                                                            </div>
                                                            {/*
                                                               ...
                                                               <div className='wishlist-buttons'>
                                                                <Button variant="default" onClick={()=>{navigate(`/product-details/${val.product_id}`)}}>Open Product</Button>
