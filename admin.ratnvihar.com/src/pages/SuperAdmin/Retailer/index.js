  ...
  render() {    
    ...
    return (
      <>
        ...
        <MainCard title="Retailers" secondary={(!this.isSalesExecutive && !this.isAdmin && !this.isDistributor && hasPermission(this.state.permissions, 'retailer', 'add')) ? <Button variant="contained" onClick={() => this.props.navigate('create') }>Add</Button> : null} >
