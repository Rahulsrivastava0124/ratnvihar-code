      ...
      <MainCard title="Size" >
        {
          ...
          <div className='tax-input p_view loans_view'>
            <SizeForm onSubmit={this.submit} formData={this.state.editRow} handleCancel={this.handleCancel} subcategories={this.state.subCategoryList} nameChange={this.nameChange} subCategoryChange={this.subCategoryChange} submitSuccess={this.state.submitSuccess} />
          </div>
          : null
        }
            ...
            actions={[
              {
                ...
                color: 'primary',
                show: hasPermission(this.state.permissions, 'size', 'edit')
              },
              {
                label: 'Delete',
                ...
                isDelete: true,
                color: 'error',
                show: hasPermission(this.state.permissions, 'size', 'delete')
              }
            ]}
          />
        </Grid>
        ...
        <DialogContent>
          <DialogContentText></DialogContentText>
            <SizeForm onSubmit={this.submit} formData={this.state.editRow} handleCancel={this.handleCancel} subcategories={this.state.subCategoryList} />
        </DialogContent>
      </Dialog>
...
const mapDispatchToProps = dispatch => ({
  dispatch,
  actions: bindActionCreators({sizeList, sizeCreate, sizeUpdate, sizeDelete, subCategoryList}, dispatch)
});
