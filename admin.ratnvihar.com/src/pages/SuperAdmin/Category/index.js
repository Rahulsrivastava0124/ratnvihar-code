...
import { categoryList, categoryDelete, } from 'actions/superadmin/category.actions';
...
import { categoryCreate, categoryUpdate } from 'actions/superadmin/category.actions';
...
class CategoryPage extends Component {
  ...
  render() {
    ...
    return (
      <MainCard title="Category" secondary={hasPermission(this.state.permissions, 'category', 'add') ? <Button variant="contained" onClick={this.handleCreate}>Add</Button> : null} >
        ...
        <Grid container spacing={gridSpacing}>
          <DataTable
            ...
            actions={[
              ...
              },
              {
                ...
                isDelete: true,
                color: 'error',
                show: hasPermission(this.state.permissions, 'category', 'delete')
              }
            ]}
          />
        </Grid>
          ...
          >
            ...
            <DialogContent>
              ...
              <CategoryForm onSubmit={this.submit} formData={this.state.editRow} handleCancel={this.handleCancel} />
            </DialogContent>
          </Dialog>
...
const mapDispatchToProps = dispatch => ({
  dispatch,
  actions: bindActionCreators({ categoryList, categoryCreate, categoryUpdate, categoryDelete, categoryList }, dispatch)
});


export default withSnackbar(withRouter(connect(mapStateToProps, mapDispatchToProps)(CategoryPage)));
