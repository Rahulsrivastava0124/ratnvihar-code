...
import { subCategoryList, subCategoryDelete, subCategoryCreate, subCategoryUpdate } from 'actions/superadmin/subCategory.actions';
      ...
      <MainCard title="Sub Category" >
        {
          ...
          <div className='tax-input loans_view p_view'>
            <SubCategoryForm onSubmit={this.submit} formData={this.state.editRow} categories={this.state.categories} handleCancel={this.handleCancel} categoryChange={this.categoryChange} submitSuccess={this.state.submitSuccess} nameChange={this.nameChange} />
          </div>
          : null
        }
        <Grid container spacing={gridSpacing}>
            ...
            actions={[
              {
                ...
                color: 'primary',
                show: hasPermission(this.state.permissions, 'sub_category', 'edit')
              },
              {
                label: 'Delete',
          ...
          >
            ...
            <DialogContent>
              ...
              <SubCategoryForm onSubmit={this.submit} formData={this.state.editRow} categories={this.state.categories} handleCancel={this.handleCancel} submitSuccess={this.state.submitSuccess} />
            </DialogContent>
          </Dialog>
...
const mapDispatchToProps = dispatch => ({
  dispatch,
  actions: bindActionCreators({ subCategoryList, subCategoryCreate, subCategoryUpdate, subCategoryDelete, categoryList }, dispatch)
});


export default withSnackbar(withRouter(connect(mapStateToProps, mapDispatchToProps)(SubCategoryPage)));
