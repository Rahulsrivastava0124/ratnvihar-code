  ...
  render() {   
    ...
    return (
      <>
        ...
        <MainCard title="Suppliers" secondary={(!isDistributor() && hasPermission(this.state.permissions, 'supplier', 'add')) ? <Button variant="contained" onClick={() => this.props.navigate('create') }>Add</Button> : null} >
